...
<div class="w-4/5 flex">
    <div class="p-3 w-2/3 container">
        <div class="rounded flex flex-col bg-gray-700 p-3 flex shadow-lg my-5">
            <div class="flex justify-between w-full">
                <div class="flex text-gray-400">
                    <img src="{{ asset('./images/user1.png') }}" alt="" height="30" width="30">
                    <p class="px-3">{{ $post->user->username }} {{'@'}}{{ $post->community->community_name }}</p>
                </div>
                <div class="flex text-gray-400">
            ...
            <div class=" flex flex-col pl-8 flex  my-5">
                @if ($comments->count())
                ...
                <div class="flex flex-col border-l-2 border-blue-400 m-3 bg-gray-600 text-gray-400">
                    <div class="flex justify-between w-full p-3">
                        <div class="flex text-gray-400">
                            <img src="{{ asset('./images/user1.png') }}" alt="" height="30" width="30">
                            <p class="px-3">{{ $comment->user->username }}
