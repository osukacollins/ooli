...
@section('content')
<div class="bg-scroll h-screen flex" style="background-image: url({{ asset('./images/disco-ball.png') }}), url({{ asset('./images/Clouds.png') }});
  background-position: left top, right bottom;
  background-repeat: no-repeat, no-repeat;">
    <div class="flex  justify-center self-center">

        <div class="flex justify-center flex-col p-10 w-2/3">
            <div class="h-30"> </div>
            <div class="flex text-center justify-center text-gray-400 p-3">
                <p class="text-6xl  font-light">Join the Ooli communities</p>
            </div>
            <div class="flex text-center justify-center text-gray-400 p-3">
                <p class="text-xl">Join friends and communities at Ooli and experience ultimate fun.
...
{{-- The second section --}}
<div class="h-screen flex flex-col p-10 justify-center">
    <div class="flex text-gray-400 text-center justify-center p-3">
        <p class="text-6xl font-bold" id="about">About Ooli Communities
        </p>
    </div>
    <div class="flex text-center justify-center text-gray-400 p-3">
        <p class="text-lg text-light">What makes Ooli communities different?</p>
    </div>
    <div class="flex p-3">
        <div class="p-5 flex w-1/3">
...
<div class="flex p-3 self-end justify-self-center justify-center">
