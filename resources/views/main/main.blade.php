...
<body>
    <div class="mx-auto bg-gray-800">
        <nav class="flex justify-between text-gray-400 text-base top-0 z-50">
            <div>
                <a href="/home">
        ...
        <div class="flex">
            <div class="h-screen w-1/5 p-3 sticky">
                <div class="flex p-3">
    ...
    <div class="flex p-3 self-end justify-self-center justify-center bg-gray-800">
